...
export const set5Questions = [
  ...
  ...attach("set5-search-filter-sync", [
    ...
    fill("Complete a debounced value hook call.", "const debouncedQuery = useDebounce(query, __1__);", [{ label: "__1__", answers: ["300", "500"] }], "A few hundred milliseconds is common for search debounce."),
  ...
  ...attach("set5-env-config", [
    ...
    fill("Complete a safe API client base URL fallback.", "const baseUrl = import.meta.env.VITE_API_URL ?? \"__1__\";", [{ label: "__1__", answers: ["/api"] }], "A fallback can make local/proxy setup easier."),
