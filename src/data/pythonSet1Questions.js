...
export const pythonSet1Questions = [
  ...
  ...attach("py1-input-basics", [
    ...
    mcq("Why does this code raise a TypeError?", ["age is a string, so age + 5 tries to mix text and number", "print is not allowed after input", "5 must be in quotes always"], "age is a string, so age + 5 tries to mix text and number", "input() returns text, so it must be converted with int() before doing math.", code("age = input(\"Age: \")", "print(age + 5)")),
  ...
  ...attach("py1-variables-assignment", [
    ...
    mcq("What is the value of x after this code?", ["7", "5", "x"], "7", "Reassignment replaces the old value, so the last assignment wins.", code("x = 5", "x = 7")),
  ...
  ...attach("py1-multiple-values", [
    ...
    fill("Complete the list so second receives B.", "first, second = [\"A\", \"__1__\"]", [{ label: "__1__", answers: ["B"] }], "The second variable receives \"B\"."),
  ...
  ...attach("py1-numbers", [
    ...
    fill("Assign the integer -5 to temperature.", "temperature = __1__", [{ label: "__1__", answers: ["-5"] }], "A number can be assigned directly without quotes."),
  ...
  ...attach("py1-strings-basics", [
    ...
    fill("Create a string holding Ali using double quotes.", "name = __1__", [{ label: "__1__", answers: ["\"Ali\""] }], "Text values need quotes."),
    fill("Create a string holding Ali using single quotes.", "name = __1__", [{ label: "__1__", answers: ["'Ali'"] }], "Single quotes are valid too."),
  ...
  ...attach("py1-errors-mini", [
    ...
    mcq("What error is likely when a required block is not indented?", ["IndentationError", "CommentError", "StringError"], "IndentationError", "Python expects an indented block after the if header.", code("if True:", "print(\"Hi\")")),
    fill("Assign the text Ali to name, with the quotes it needs.", "name = __1__", [{ label: "__1__", answers: ["\"Ali\"", "'Ali'"] }], "Text values need quotes."),
