...
export const pythonSet1Questions = [
  ...
  ...attach("py1-multiple-values", [
    ...
    mcq("What is printed?", ["apple", "banana", "cherry"], "apple", code("fruits = [\"apple\", \"banana\", \"cherry\"]", "a, b, c = fruits", "print(a)")),
    mcq("What is printed?", ["cherry", "banana", "apple"], "cherry", code("fruits = [\"apple\", \"banana\", \"cherry\"]", "a, b, c = fruits", "print(c)")),
  ...
  ...attach("py1-numbers", [
    ...
    mcq("What is printed?", ["float", "int", "str"], "float", code("x = 2.0", "print(type(x))")),
    mcq("What is printed?", ["int", "float", "str"], "int", code("x = -12", "print(type(x))")),
  ...
  ...attach("py1-strings-basics", [
    ...
    mcq("What is printed?", ["P", "y", "Python"], "P", code("word = \"Python\"", "print(word[0])")),
  ...
  ...attach("py1-fstrings", [
    ...
    mcq("What is printed?", ["Hello Ali", "Hello {name}", "Hello name"], "Hello Ali", code("name = \"Ali\"", "print(f\"Hello {name}\")")),
    ...
    mcq("What is printed?", ["Next year: 21", "Next year: age + 1", "Next year: {age + 1}"], "Next year: 21", code("age = 20", "print(f\"Next year: {age + 1}\")")),
  ...
  ...attach("py1-booleans-comparisons", [
    ...
    mcq("Which boolean value is valid Python?", ["False", "false", "FALSE"], "False", "False must start with a capital F."),
  ...
  ...attach("py1-scope-global", [
    mcq("What is printed?", ["Python is awesome", "Python is fantastic"], "Python is awesome", code("x = \"awesome\"", "def myfunc():", "    x = \"fantastic\"", "myfunc()", "print(\"Python is \" + x)")),
    ...
    mcq("What is printed?", ["Python is fantastic", "Python is awesome"], "Python is fantastic", code("x = \"awesome\"", "def myfunc():", "    global x", "    x = \"fantastic\"", "myfunc()", "print(\"Python is \" + x)")),
