...
- Lesson coverage is now 100% (296/296 modules). React S2-5 lessons live in src/data/reactLessons.js (read-along JSX); Python S2-4 lessons live in src/data/pythonLessonsExtra.js (export pythonExtraLessons, runnable examples verified with CPython). Both are merged into lessonsByModule in App.jsx and checked by the audit's coverage report.
